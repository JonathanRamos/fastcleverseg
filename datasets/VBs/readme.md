...
Table 1: <bf>Details of the exams used to compose the MRI dataset in \cite{SpineWeb11}.</bf> \#VB: Total of segmented vertebral bodies in the exam. Pathologies: scoliosis (Sco), vertebra fracture (VF), spondylolisthesis (SL), and + represents other pathologies not diagnosable from vertebra segmentation.
